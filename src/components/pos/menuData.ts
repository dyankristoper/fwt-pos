...
export const menuItems: MenuItem[] = [
  ...
  { id: 'coke-regular', sku_code: 'C0KE', name: 'Coke Regular', price: 75, category: 'beverages', kcal: 140 },
  { id: 'sprite', sku_code: 'SPR1TE', name: 'Sprite', price: 75, category: 'beverages', kcal: 140 },
